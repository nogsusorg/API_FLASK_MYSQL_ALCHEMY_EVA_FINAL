...
class Producto(Base):
    __tablename__ = 'harr_productos'

    id = Column(Integer, primary_key=True, index=True)
    idOrigen = Column(Integer, ForeignKey('harr_mercados.id'), nullable=False, index=True)
    nombre = Column(String(150), index=True)
